      ...
      <div class="home">
          ...
          <div id="Home_title_ss">
              ...
              echo '<input type="hidden" name="date" value="'.$ladateAMJ.'"></br>';
              ?>
          </div>
        ...
        echo 'Formule associée ';
        echo "<select name = 'formule'>";
        // Parcours du tableau de résultat et affichage du résultat
        foreach($lesFormules as $valeur)
        {
            echo "<option value=".$valeur['id']. ">". $valeur['libelleFormule'] ."</option>";
        }
        echo "</select></br>"
                . '<input type="hidden" name="dateMenu" value="'.$ladateAMJ.'">'
