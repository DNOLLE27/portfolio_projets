  ...
  <body>
    ...
    <ul class="nav sidebar-nav">
        ...
        if (isset($_SESSION['statut']))
        {
            ...
            <li>
            <a href="index.php?uc=gestion&action=formulesAfficher" id="bthome">Formules</a>
            </li>
            <li>
            ...
            <li>
                <a href="index.php?uc=gestion&action=utilisateurs" id="GestionUtilisateurs">Gestion des Utilisateurs</a>
            </li>
            <li>
