...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 28 avr. 2022 à 13:06
...
CREATE TABLE IF NOT EXISTS `elior_formule` (
  ...
  `idFormule` int NOT NULL AUTO_INCREMENT,
  `libFormule` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `elior_formule` (`heureDebutCde`, `prixRepas`, `nbRepasDecouvert`, `idFormule`, `libFormule`) VALUES
('09:30:00', '4.50', 0, 1, 'Plat + dessert'),
('09:30:00', '4.50', 0, 2, 'Entrée + plat'),
('09:30:00', '5.25', 0, 3, 'Entrée + plat + dessert'),
('09:30:00', '3.50', 0, 4, 'Plat'),
('09:30:00', '3.00', 0, 5, 'Restauration rapide');
...
CREATE TABLE IF NOT EXISTS `elior_menu` (
  ...
  `idFormuleMenu` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`dateMenu`,`numMenu`),
  KEY `idFormuleMenu` (`idFormuleMenu`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `elior_menu` (`dateMenu`, `numMenu`, `descriptionMenu`, `idFormuleMenu`) VALUES
...
('2021-11-15', 1, 'Pizza Kebab / Carottes et lardons / Cake aux Quetsches', 3),
...
('2022-01-16', 1, 'cuisse de poulet à l\'Américaine - riz créole / moelleux au fromage', 2),
('2022-01-16', 2, 'filet de hoki sauce vierge - riz créole / moelleux au fromage', 2),
...
('2022-06-26', 3, 'haut de cuisse de poulet - macaronis / neige aux myrtilles', 1);
...
(8, '', '', 1, '', 'd41d8cd98f00b204e9800998ecf8427e', 1, 0),
(9, 'LE COCGUEN', 'Guillaume', 2, 'LECOCGUENG', 'd41d8cd98f00b204e9800998ecf8427e', 1, 9),
(10, 'CHAPELAIN', 'Gael', 1, 'CHAPELAING', 'd41d8cd98f00b204e9800998ecf8427e', 1, 0),
(11, 'DA SILVA MARQUES', 'Lucas', 1, 'DASILVAL', 'd41d8cd98f00b204e9800998ecf8427e', 1, 0),
...
--
-- Contraintes pour la table `elior_commande`
--
ALTER TABLE `elior_commande`
  ADD CONSTRAINT `elior_commande_ibfk_1` FOREIGN KEY (`dateMenu`,`numMenu`) REFERENCES `elior_menu` (`dateMenu`, `numMenu`),
  ADD CONSTRAINT `elior_commande_ibfk_2` FOREIGN KEY (`idUtil`) REFERENCES `elior_utilisateur` (`id`),
  ADD CONSTRAINT `elior_commande_ibfk_3` FOREIGN KEY (`dateMenu`,`numMenu`) REFERENCES `elior_menu` (`dateMenu`, `numMenu`);

--
-- Contraintes pour la table `elior_menu`
--
ALTER TABLE `elior_menu`
  ADD CONSTRAINT `elior_menu_ibfk_1` FOREIGN KEY (`idFormuleMenu`) REFERENCES `elior_formule` (`idFormule`);

--
-- Contraintes pour la table `elior_paiement`
--
ALTER TABLE `elior_paiement`
  ADD CONSTRAINT `elior_paiement_ibfk_1` FOREIGN KEY (`idEleve`) REFERENCES `elior_utilisateur` (`id`);
COMMIT;
